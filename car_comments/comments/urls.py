...
router_country_xlsx = SimpleRouter()
router_country_xlsx.register(r'country/xlsx', viewset=views.CountryXLSXViewset)

urlpatterns = [
    path('country/xlsx/', name='get_country_xlx', view=views.CountryXLSXViewset.as_view({'get': 'list'}))
]
